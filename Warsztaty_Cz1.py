...
if liczba_2 > liczba_1 or lista_imion["Zygmunt"]:
    print("Liczba_2 jest większa od liczba_1 lub tablica zawiera imię Zygmunt")
else:
    print("liczba_2 jest mniejsza od liczba_1 albo tablica nie zawiera imienia Zygmunt")
